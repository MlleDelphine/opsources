...
// Copyright (c) 2014 IOPLEX Software
// http://www.ioplex.com/
...
if (!defined('PLEXCEL_VERSION'))
	die('Error: Plexcel PHP extension was not successfully loaded. Please check the Apache error log.');
if ('2.7.32' != PLEXCEL_VERSION)

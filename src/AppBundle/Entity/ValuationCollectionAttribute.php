 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\Repository\ValuationCollectionAttributeRepository")
 */
...
//
//    /**
//     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\ValuationMeet", inversedBy="collectionAttributes")
//     * @ORM\JoinColumn(name="valuationmeet_id", referencedColumnName="id")
//     */
//    private $valuationMeet;

    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\ValuationAttribute", inversedBy="collectionAttributes")
...
//    }
     ...
     * Set valuationMeet
     *
     * @param \AppBundle\Entity\ValuationAttribute $valuationAttribute
     * @return ValuationAttribute
     */
    public function setValuationAttribute(\AppBundle\Entity\ValuationAttribute $valuationAttribute = null)
    {
     ...
     * Get valuationMeet
     *
     * @return \AppBundle\Entity\ValuationAttribute
     */

 ...
 *
 * @DataTable\Table(id="conditionsMeetAssessorTable")
 *
 *
 */
class ConditionsMeetAssessorTable extends QueryBuilderDataTable implements QueryBuilderDataTableInterface{
    ...
    public function getQueryBuilder(Request $request = null)
    {
        ...
        $qb = $conditionsMeetRepository->createQueryBuilder('conditionsMeet')
            ->leftJoin('conditionsMeet.assessor', 'aor')
